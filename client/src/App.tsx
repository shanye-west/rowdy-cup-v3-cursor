          ...
          try {
            ...
            switch (message.type) {
              ...
              case 'score-created':
                ...
                queryClient.invalidateQueries({ queryKey: [`/api/scores?matchId=${message.data.matchId}`] });
                break;
                
              case 'match-updated':
                // Invalidate match queries
                queryClient.invalidateQueries({ queryKey: [`/api/matches/${message.data.id}`] });
                queryClient.invalidateQueries({ queryKey: [`/api/matches?roundId=${message.data.roundId}`] });
                break;
